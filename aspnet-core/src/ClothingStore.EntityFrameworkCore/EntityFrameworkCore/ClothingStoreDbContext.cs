using ClothingStore.Configurations.Inventories;
using ClothingStore.Configurations.InventoriesTickets;
using ClothingStore.Configurations.Manufacturers;
using ClothingStore.Configurations.Orders;
using ClothingStore.Configurations.ProductAttributes;
using ClothingStore.Configurations.ProductCategories;
using ClothingStore.Configurations.Products;
using ClothingStore.Configurations.Promotions;
...
using ClothingStore.ProductAttributes;
using ClothingStore.ProductCategories;
...
public class ClothingStoreDbContext :
    AbpDbContext<ClothingStoreDbContext>,
    IIdentityDbContext,
